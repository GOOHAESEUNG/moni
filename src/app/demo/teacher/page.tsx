  ...
  return (
    ...
    >
      ...
      <div className="flex-1 px-3 py-4 space-y-1">
        ...
        <Link href="/demo/teacher" className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors hover:bg-white/[0.06]" style={{ color: 'rgba(255,255,255,0.55)' }}>
          <ChartBar size={18} />
